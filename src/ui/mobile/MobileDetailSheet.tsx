...
export function MobileDetailSheet() {
  ...
  return (
    <section
      ...
      className="glass absolute inset-x-0 bottom-0 z-20 flex flex-col rounded-b-none pb-[env(safe-area-inset-bottom)] text-white transition-[height] duration-200"
      style={{ height: sheetState === 'expanded' ? '85dvh' : '40dvh' }}
    >
      <div
