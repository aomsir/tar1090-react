  ...
  if (scrollable) {
    ...
    return (
      <div
        ...
        className="h-0 min-h-[200px] flex-1 [contain:size] overflow-y-auto pr-1 scrollbar-none [mask-image:linear-gradient(to_bottom,black_14px,black_calc(100%_-_14px),transparent_100%)]"
        tabIndex={0}
      >
        {list}
      </div>
